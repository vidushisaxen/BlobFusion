import { Environment, MeshTransmissionMaterial, OrbitControls, PerspectiveCamera, useEnvironment } from "@react-three/drei";
...
float pattern = wave(noisePattern/n);
...
const Shape = () => {
  ...
  const envMap = useEnvironment({files: '/assets/empty.hdr'})
  ...
  return (
    <mesh ref={ref}>
      ...
      {/* <MeshTransmissionMaterial   roughness={0.1}
        metalness={0.8} envMap={envMap} thickness={0.2}  clearcoat={1}/> */}
    </mesh>
  );
};
